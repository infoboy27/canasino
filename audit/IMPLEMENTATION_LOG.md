...
- Canopy plugin candidate: `audit/canasino-financial-hardening` at `b7375e72` (fair-randomness-v2 A.2-A.4; was `ee3b4e6e`), based on production `cd4cd495`.
...
| 3 | Fair close/reveal randomness | PLUGIN IMPLEMENTED (Option A); BLOCKING | Bets close before unpredictable entropy; deterministic settle; abort-safe refund/penalty. Plugin close/bond/settle/expire done + replay-tested; game-server consumption and isolated-node E2E remain |
